...
export const ReportsView: React.FC<ReportsViewProps> = ({
  ...
  return (
    <div className="space-y-6" id="reports-printable-root">
      ...
      {/* Top Header Bar */}
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 pb-2 border-b border-[#E5E7EB] dark:border-[#334155]">
        <div>
      ...
      <div className="flex items-center gap-2 bg-white dark:bg-[#1E293B] border border-[#E5E7EB] dark:border-[#334155] rounded-[12px] p-1.5 shadow-2xs overflow-x-auto text-xs print:hidden">
        {[
          ...
          <button
            ...
            className={`px-4 py-2 rounded-[8px] font-semibold transition-all whitespace-nowrap cursor-pointer ${
              activeTab === tab.id
                ...
                : 'text-gray-600 dark:text-[#CBD5E1] hover:text-gray-900 dark:hover:text-white hover:bg-slate-50 dark:hover:bg-[#273549]'
            }`}
          >
            {tab.label}
          </button>
