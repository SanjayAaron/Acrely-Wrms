  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} title="Mark Payment as Unpaid" maxWidth="max-w-md">
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        {/* Audit Notes */}
        <div>
          <label className="block text-xs font-semibold text-[#111827] dark:text-[#F8FAFC] mb-1">
          ...
          <textarea
            ...
            rows={2}
            className="w-full text-xs px-3 py-2 border border-[#E5E7EB] dark:border-[#334155] rounded-[8px] focus:outline-hidden focus:border-[#2563EB] text-[#111827] dark:text-[#F8FAFC] bg-white dark:bg-[#1E293B]"
