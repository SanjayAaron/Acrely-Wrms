  ...
  return (
    ...
    >
      <form onSubmit={handleSubmit} className="space-y-8">
        {formError && (
          <div className="p-3 bg-rose-50 dark:bg-rose-950/40 border border-rose-200 dark:border-rose-800 rounded-[10px] text-xs text-rose-700 dark:text-rose-400 font-semibold">
            {formError}
          </div>
        )}
        ...
        <div className="space-y-4">
          ...
          <div className="p-3 bg-slate-50 dark:bg-[#1E293B] border border-[#E5E7EB] dark:border-[#334155] rounded-[10px] flex items-center gap-4">
            <div className="w-12 h-12 rounded-full bg-slate-200 dark:bg-slate-800 border border-[#E5E7EB] dark:border-[#334155] overflow-hidden flex items-center justify-center shrink-0">
              {photoUrl ? (
                <img src={photoUrl} alt="Staff profile" className="w-full h-full object-cover" />
              ) : (
                <User className="w-6 h-6 text-gray-400 dark:text-[#64748B]" />
              )}
            </div>
            <div className="flex-1">
              <label className="block text-xs font-semibold text-[#111827] dark:text-[#F8FAFC] mb-0.5">
                Profile Photo Upload
              </label>
            ...
            <label className="inline-flex items-center gap-1.5 px-3 py-1.5 bg-white dark:bg-[#273549] border border-[#E5E7EB] dark:border-[#334155] rounded-[8px] text-xs font-semibold text-[#111827] dark:text-[#F8FAFC] hover:bg-slate-100 dark:hover:bg-[#334155] cursor-pointer shadow-2xs">
              <Camera className="w-3.5 h-3.5 text-[#2563EB] dark:text-blue-400" />
        ...
        <div className="space-y-4">
          <div className="flex items-center gap-2 pb-2 border-b border-[#E5E7EB] dark:border-[#334155]">
            <Settings className="w-4 h-4 text-[#2563EB] dark:text-blue-400" />
            <h3 className="text-xs font-bold text-[#111827] dark:text-[#F8FAFC] uppercase tracking-wider">
              Section 4: Account Settings
            </h3>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div className="p-3 bg-slate-50 dark:bg-[#1E293B] border border-[#E5E7EB] dark:border-[#334155] rounded-[10px] flex items-center gap-3">
              <input
              ...
              <label htmlFor="forcePasswordChange" className="text-xs cursor-pointer">
                <span className="font-semibold text-[#111827] dark:text-[#F8FAFC] block">Temporary Password</span>
                <span className="text-[10px] text-gray-500 dark:text-[#94A3B8]">Force password change on first login</span>
              </label>
            </div>

            <div className="p-3 bg-slate-50 dark:bg-[#1E293B] border border-[#E5E7EB] dark:border-[#334155] rounded-[10px] flex items-center gap-3 opacity-80">
              <input
                id="twoFactor"
                type="checkbox"
              ...
              <label htmlFor="twoFactor" className="text-xs cursor-pointer">
                <span className="font-semibold text-[#111827] dark:text-[#F8FAFC] flex items-center gap-1">
                  Two-factor authentication
                  <span className="text-[9px] px-1.5 py-0.5 bg-blue-100 dark:bg-blue-950 text-[#2563EB] dark:text-blue-400 rounded font-bold">Future</span>
                </span>
                <span className="text-[10px] text-gray-500 dark:text-[#94A3B8]">Enforce OTP login verification</span>
              </label>
            </div>
          </div>
        </div>
        ...
        <div className="flex items-center justify-end gap-3 pt-4 border-t border-[#E5E7EB] dark:border-[#334155]">
