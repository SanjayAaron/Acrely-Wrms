  ...
  return (
    <div className="space-y-3">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2">
        <div>
          <h4 className="text-xs font-bold text-[#111827] dark:text-[#F8FAFC] flex items-center gap-1.5">
        ...
        {isOwnerRole && (
          <span className="inline-flex items-center gap-1 px-2.5 py-1 bg-blue-50 dark:bg-blue-950/60 text-[#2563EB] dark:text-blue-400 border border-[#2563EB]/30 dark:border-blue-800 rounded-md text-[11px] font-bold">
            All Granted (Owner)
          </span>
        )}
      </div>

      <div className="border border-[#E5E7EB] dark:border-[#334155] rounded-[10px] overflow-hidden bg-white dark:bg-[#1E293B] text-xs">
          ...
          <table className="w-full text-left border-collapse">
              ...
              <tr>
                ...
                <th className="px-3 py-2.5 text-center w-20">
                  <button
                    ...
                    className="hover:text-[#2563EB] dark:hover:text-blue-400 cursor-pointer"
                  >
                    View
                  </button>
                </th>
            ...
            <tbody className="divide-y divide-[#E5E7EB] dark:divide-[#334155]">
              {modulesList.map((modKey) => {
                ...
                return (
                  <tr key={modKey} className="hover:bg-slate-50/60 dark:hover:bg-[#273549]/50">
                    <td className="px-4 py-2.5">
                      <div className="font-semibold text-[#111827] dark:text-[#F8FAFC]">{info.name}</div>
                      <div className="text-[10px] text-gray-500 dark:text-[#94A3B8]">{info.description}</div>
                    </td>
