    ...
    <Modal isOpen={isOpen} onClose={onClose} title={`${type} Enterprise Document Preview`} maxWidth="max-w-4xl">
      <div className="space-y-4">
        ...
        <div
          ...
          className="bg-white dark:bg-[#1E293B] print:bg-white border border-[#E5E7EB] dark:border-[#334155] print:border-gray-200 rounded-2xl p-8 text-xs text-[#111827] dark:text-[#F8FAFC] print:text-black space-y-6 shadow-2xs font-sans max-w-3xl mx-auto"
        >
