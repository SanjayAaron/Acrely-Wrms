...
Oragadam,
Chennai - 602105`}
            className="w-full bg-white dark:bg-[#1E293B] border border-[#E5E7EB] dark:border-[#334155] text-[#111827] dark:text-[#F8FAFC] text-sm rounded-[12px] p-3 focus:outline-none focus:ring-2 focus:ring-[#2563EB]/20 focus:border-[#2563EB] placeholder-gray-400 dark:placeholder-[#64748B]"
          />
        </div>

        {/* Lease End Date Field - Directly below Warehouse Address and above Property Notes */}
        <Input
        ...
        <div className="flex justify-end gap-3 pt-3 border-t border-[#E5E7EB] dark:border-[#334155]">
