...
export const NotificationSidebar: React.FC<NotificationSidebarProps> = ({
  ...
  return (
    <aside className="w-full lg:w-60 bg-slate-50/80 dark:bg-[#111827]/80 border-r border-[#E5E7EB] dark:border-[#334155] p-3.5 flex flex-col gap-1.5 shrink-0">
      <div className="px-2 py-1 text-[10px] font-bold text-gray-400 dark:text-[#64748B] uppercase tracking-wider mb-1">
        Categories & Modules
      </div>
