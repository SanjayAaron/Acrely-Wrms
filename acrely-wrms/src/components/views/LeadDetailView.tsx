            ...
            <CardContent className="p-4 space-y-3">
              ...
              <div className="grid grid-cols-2 gap-2 pt-1">
                {prevStage ? (
                  ...
                  <div className="text-[11px] text-gray-400 dark:text-[#64748B] italic flex items-center justify-center p-2 border border-dashed border-[#E5E7EB] dark:border-[#334155] rounded-[8px] bg-white/60 dark:bg-[#1E293B]/60">
                    At Start Stage
                  </div>
                )}
