            ...
            <div className="h-64 w-full">
              <ResponsiveContainer width="100%" height="100%">
                ...
                >
                  ...
                  <Bar dataKey="Current" stackId="a" fill="#2563EB" name="Current (Not Due)" />
                  <Bar dataKey="1-30 Days" stackId="a" fill="#F59E0B" name="1-30 Days Overdue" />
                  <Bar dataKey="31-60 Days" stackId="a" fill="#F97316" name="31-60 Days Overdue" />
                  <Bar dataKey="61-90 Days" stackId="a" fill="#E11D48" name="61-90 Days Overdue" />
                  <Bar dataKey="90+ Days" stackId="a" fill="#991B1B" name="90+ Days Critical" />
                </BarChart>
              </ResponsiveContainer>
            </div>
          )}
