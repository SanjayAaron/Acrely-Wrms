      ...
      >
        <div className="space-y-5">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="p-4 bg-white border border-[#E5E7EB] rounded-[12px] space-y-3">
              ...
              <div className="space-y-2 text-xs">
                <div className="flex justify-between py-1 border-b border-gray-100">
                  ...
                  <span className="font-mono font-bold text-[#111827]">{payment.invoiceNumber}</span>
                </div>
                <div className="flex justify-between py-1 border-b border-gray-100">
            ...
            <div className="p-4 bg-white border border-[#E5E7EB] rounded-[12px] space-y-3">
              ...
              <div className="space-y-2 text-xs">
                ...
                <div className="flex justify-between py-1 border-b border-gray-100">
                  ...
                  <span className="font-mono text-[#111827]">{tenant?.phone || '+91 98200 12345'}</span>
                </div>
                <div className="flex justify-between py-1 border-b border-gray-100">
                  <span className="text-gray-500 flex items-center gap-1">
                    <Mail className="w-3 h-3 text-gray-400" /> Email
                  </span>
                  <span className="text-[#2563EB] font-medium">{tenant?.email || `contact@${payment.tenantName.toLowerCase().replace(/\s+/g, '')}.com`}</span>
                </div>
                <div className="flex justify-between py-1 border-b border-gray-100">
                  <span className="text-gray-500">Lease Start</span>
                  <span className="font-semibold text-gray-800">{tenant?.leaseStart || '2025-01-01'}</span>
                </div>
                <div className="flex justify-between py-1 border-b border-gray-100">
                  <span className="text-gray-500">Lease End</span>
                  <span className="font-semibold text-gray-800">{tenant?.leaseEnd || '2026-12-31'}</span>
                </div>
                <div className="flex justify-between items-center pt-1">
                  <span className="text-gray-500">Next Due Date</span>
                  <span className="font-bold text-[#2563EB]">{payment.nextDueDate || '2026-08-05'}</span>
                </div>
              </div>
            </div>
            ...
            <div className="p-4 bg-white border border-[#E5E7EB] rounded-[12px] space-y-3">
              ...
              <div className="space-y-2 text-xs">
                <div className="flex justify-between py-1 border-b border-gray-100">
                  ...
                  <span className="font-bold text-[#111827]">{payment.warehouseName}</span>
                </div>
                <div className="flex justify-between py-1 border-b border-gray-100">
                  <span className="text-gray-500 flex items-center gap-1">
                    <MapPin className="w-3 h-3 text-gray-400" /> Address
                  </span>
                  <span className="font-semibold text-gray-800 truncate max-w-[180px]" title={warehouse?.address}>
                    {warehouse?.address?.split('\n')[0] || warehouse?.locationZone || 'Address not provided'}
                  </span>
                </div>
                <div className="flex justify-between py-1 border-b border-gray-100">
                  <span className="text-gray-500 flex items-center gap-1">
                    <Maximize2 className="w-3 h-3 text-gray-400" /> Total Area
                  </span>
