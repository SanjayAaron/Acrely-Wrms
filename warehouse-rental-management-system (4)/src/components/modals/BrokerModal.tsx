      ...
      <form onSubmit={handleSubmit} className="space-y-6 max-h-[80vh] overflow-y-auto pr-1">
        ...
        <div className="p-4 bg-slate-50/80 border border-[#E5E7EB] rounded-xl space-y-4">
          <div className="flex items-center gap-2 pb-2 border-b border-[#E5E7EB]">
            ...
            <h3 className="font-bold text-sm text-[#111827]">Section 1: Basic Information</h3>
          </div>
          ...
          <div className="space-y-2">
                  ...
                  <button
                    ...
                    className={`px-3 py-1.5 rounded-lg text-xs font-medium transition-all flex items-center gap-1.5 cursor-pointer ${
                      isSelected
                        ...
                        : 'bg-white border border-[#E5E7EB] text-gray-700 hover:bg-slate-100'
                    }`}
                  >
            ...
            <div className="flex items-center gap-2 pt-1">
              <input
                ...
                className="text-xs px-3 py-1.5 border border-[#E5E7EB] rounded-lg bg-white focus:outline-none focus:border-[#2563EB] flex-1"
              />
          ...
          {(formData.documents || []).length === 0 ? (
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
              {(formData.documents || []).map((doc) => (
                <div
                  key={doc.id}
                  className="p-2.5 bg-white border border-[#E5E7EB] rounded-lg flex items-center justify-between gap-2 text-xs"
                >
        ...
        {/* Section 8: Notes */}
        <div className="p-4 bg-slate-50/80 border border-[#E5E7EB] rounded-xl space-y-2">
          <div className="flex items-center gap-2 pb-2 border-b border-[#E5E7EB]">
            <FileText className="w-4 h-4 text-[#2563EB]" />
            <h3 className="font-bold text-sm text-[#111827]">Section 8: Notes</h3>
          </div>
          ...
          <textarea
            ...
            className="w-full p-3 text-xs border border-[#E5E7EB] rounded-lg bg-white focus:outline-none focus:border-[#2563EB] text-[#111827]"
          />
        </div>
